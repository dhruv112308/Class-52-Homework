...
var playerArrows = [];
var computerArrows = [];
var playerArcherLife = 5;
var computerArcherLife = 5;
...
function draw() {
  ...
  textSize(20)
  textAlign("center")
  text("Use left and right arrow buttons to move bow and up arrow button to shoot", width / 2, 800)
  ...
  for (var i = 0; i < playerArrows.length; i++) {
    ...
    if (
      ...
      if (computerArcherLife <= 0) {
        ...
        textAlign("center")
        fill("White")
        text("Game Over, You Win!", width / 2, 400)
      }
    }
  }
}
  ...
  for (var i = 0; i < computerArrows.length; i++) {
    ...
    if (
      ...
      if (playerArcherLife <= -1) {
        ...
        textAlign("center")
        fill("white")
        text("Game Over, You Lose!", width / 2, 400)
